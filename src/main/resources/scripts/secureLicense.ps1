...
$Subject = "Status serwera licencji"
$Body = "Serwer licencji zatrzymany. Status zostanie sprawdzony ponownie za 2 minuty."
...
while($true)
{
 ...
 If ((Get-Service "Computec License Server").status -eq "Stopped")
  {
        Try
         {
